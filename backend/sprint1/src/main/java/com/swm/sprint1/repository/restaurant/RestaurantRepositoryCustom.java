...
public interface RestaurantRepositoryCustom {
    ...
    List<Restaurant> findRestaurantByLatitudeAndLongitudeAndCategory(BigDecimal latitude, BigDecimal longitude, BigDecimal radius, Long category_id, Long limit);
}
